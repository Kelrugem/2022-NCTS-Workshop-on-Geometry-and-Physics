...
\begin{frame}{Guide to recover the classics: Part 1 of 3}
\begin{remark}
\begin{enumerate}
...
\begin{frame}{Guide to recover the classics: Part 2 of 3}
\begin{remark}
\begin{enumerate}
	\item $\mathcal{G} \cong M \times G$
	\pause
...
{
\setbeamertemplate{footline}{}
\begin{frame}{Guide to recover the classics: Part 3 of 3}
\begin{remark}
\begin{enumerate}
	\item $\mathcal{G} \cong M \times G$
	\item Equip $\mathcal{G}$ with canonical flat connection
